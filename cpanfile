...
on develop => sub {
    ...
    requires 'Perl::Critic::Policy::Freenode::AmpersandSubCalls', '0.030';
    requires 'Perl::Critic::Policy::Freenode::ArrayAssignAref', '0.030';
    requires 'Perl::Critic::Policy::Freenode::BarewordFilehandles', '0.030';
    requires 'Perl::Critic::Policy::Freenode::ConditionalDeclarations', '0.030';
    requires 'Perl::Critic::Policy::Freenode::ConditionalImplicitReturn', '0.030';
    requires 'Perl::Critic::Policy::Freenode::DeprecatedFeatures', '0.030';
    requires 'Perl::Critic::Policy::Freenode::DiscouragedModules', '0.030';
    requires 'Perl::Critic::Policy::Freenode::DollarAB', '0.030';
    requires 'Perl::Critic::Policy::Freenode::Each', '0.030';
    requires 'Perl::Critic::Policy::Freenode::IndirectObjectNotation', '0.030';
    requires 'Perl::Critic::Policy::Freenode::LexicalForeachIterator', '0.030';
    requires 'Perl::Critic::Policy::Freenode::LoopOnHash', '0.030';
    requires 'Perl::Critic::Policy::Freenode::ModPerl', '0.030';
    requires 'Perl::Critic::Policy::Freenode::OpenArgs', '0.030';
    requires 'Perl::Critic::Policy::Freenode::OverloadOptions', '0.030';
    requires 'Perl::Critic::Policy::Freenode::POSIXImports', '0.030';
    requires 'Perl::Critic::Policy::Freenode::PackageMatchesFilename', '0.030';
    requires 'Perl::Critic::Policy::Freenode::PreferredAlternatives', '0.030';
    requires 'Perl::Critic::Policy::Freenode::Prototypes', '0.030';
    requires 'Perl::Critic::Policy::Freenode::StrictWarnings', '0.030';
    requires 'Perl::Critic::Policy::Freenode::Threads', '0.030';
    requires 'Perl::Critic::Policy::Freenode::Wantarray', '0.030';
    requires 'Perl::Critic::Policy::Freenode::WarningsSwitch', '0.030';
    requires 'Perl::Critic::Policy::Freenode::WhileDiamondDefaultAssignment', '0.030';
